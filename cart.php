...
//kiemtra nut them vao gio duoc nhan
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="checkout__order">
                        ...
                        <div class="checkout__order__total">Tổng tiền: <span>
                                <?= number_format($total, 0, '', '.') . " VNĐ" ?></span></div>
                        <div class="d-flex justify-content-between">
                            <a href="shop.php" type="submit" class="btn btn-primary">Tiếp tục mua sắm</a>
                            <a href="thanhtoan.php" type="submit" class="btn btn-success">Thanh toán</a>
                        </div>
